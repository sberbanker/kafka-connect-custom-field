...
public class TimestampConverterTest {
    ...
    private static final String DATE_PLUS_TIME_STRING, DATE_PLUS_TIME_STRING2;
    ...
    static {
        ...
        DATE_PLUS_TIME_STRING2 = "1970-01-02T00:00:01.234+00:00";
    }
    //endregion
    ...
    //region  Conversions without schemas (most flexible Timestamp -> other types)
    @Test
    ...
    //region Conversions without schemas (core types -> most flexible Timestamp format)
    @Test
    ...
    @Test
    public void testSchemalessStringToTimestamp2() {
        Map<String, String> config = new HashMap<>();
        config.put(TimestampConverter.TARGET_TYPE_CONFIG, "Timestamp");
        config.put(TimestampConverter.FORMAT_CONFIG, "yyyy-MM-dd'T'HH:mm:ss[.[SSSSSS][SSSSS][SSSS][SSS][SS][S]]XXX");
        config.put(TimestampConverter.TIMEZONE_CONFIG, "Etc/UTC");
        xformValue.configure(config);
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(DATE_PLUS_TIME_STRING2));
    ...
    //region Conversions with schemas (most flexible Timestamp -> other types)
    @Test
    ...
    //region Conversions with schemas (core types -> most flexible Timestamp format)
    @Test
    ...
    @Test
    public void testWithSchemaStringToTimestamp2() {
        Map<String, String> config = new HashMap<>();
        config.put(TimestampConverter.TARGET_TYPE_CONFIG, "Timestamp");
        config.put(TimestampConverter.FORMAT_CONFIG, "yyyy-MM-dd'T'HH:mm:ss[.[SSSSSS][SSSSS][SSSS][SSS][SS][S]]XXX");
        config.put(TimestampConverter.TIMEZONE_CONFIG, "Etc/UTC");
        xformValue.configure(config);
        SourceRecord transformed = xformValue.apply(createRecordWithSchema(Schema.STRING_SCHEMA, DATE_PLUS_TIME_STRING2));
    ...
    //region Null-value conversions schemaless
    @Test
    ...
    //region Null-value conversions with schema
    @Test
    ...
    //region Convert field instead of entire key/value
    @Test
    ...
    //region Validate Key implementation in addition to Value
    @Test
    public void testKey() {
